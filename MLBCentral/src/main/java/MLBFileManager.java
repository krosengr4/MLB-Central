...
public class MLBFileManager {
    ...
    public static String filePath = "src/main/resources/Teams.csv";
    ...
    public static ArrayList<Team> getALEastTeams() {
        ArrayList<Team> americanEastTeams = new ArrayList<>();
        ...
        try {
            ...
            while((input = bufferedReader.readLine()) != null) {
                ...
                if (league.equalsIgnoreCase("american") && division.equalsIgnoreCase("east")) {
                    Team team = new Team(sport, name, location, wins, losses, league, division);

                    americanEastTeams.add(team);
                } else {
                    continue;
                }
            }
